// ZENO — Payment Feature: Cancel Landing Page
// Route: /payment/cancel
// Shown when user clicks "Back" or closes the Stripe checkout.
  ...
  return (
    <main className="min-h-screen flex items-center justify-center p-6 bg-white">
      <div className="w-full max-w-lg border-4 border-black p-10 text-center">
        ...
        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center border-4 border-black bg-white text-3xl font-black text-gray-400">
          ←
        </div>
        ...
        <p className="mt-4 font-mono text-sm text-gray-600">
          ...
          <strong>pending</strong> — you can pay it anytime from the Payments
          page.
        </p>
